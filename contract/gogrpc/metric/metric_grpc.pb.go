...
func (c *metricClient) GetMetric(ctx context.Context, in *MetricRequest, opts ...grpc.CallOption) (*MetricResponse, error) {
...
func (UnimplementedMetricServer) GetMetric(context.Context, *MetricRequest) (*MetricResponse, error) {
...
func _Metric_GetMetric_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MetricServer).GetMetric(ctx, req.(*MetricRequest))
	}
...
var Metric_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "contract/protobuf/metric/metric.proto",
}
