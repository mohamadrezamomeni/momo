...
func (h *Handler) SetStateGettingClientUri(next core.HandlerFunc) core.HandlerFunc {
...
func (h *Handler) GetClientURI(update *core.Update) (*core.ResponseHandlerFunc, error) {
	...
	template, err := h.inboundSvc.LoadInboundURI(inboundID)
