...
func main() {
	...
	_, _, userSvc, inboundSvc, _, _, _, eventSvc, chargeSvc, _, _, _, _, _, _, _ := serviceInitializer.GetServices(&cfg)
	...
	go func() {
		wg.Add(1)
		scheduler := scheduler.NewNotificationSchaduler(notification)
