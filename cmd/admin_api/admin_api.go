...
func main() {
	...
	migration.UP()
	hostSvc, vpnSvc, userSvc, inboundSvc, authSvc, cryptSvc, vpnPackageSvc, _, chargeSvc, _, _, _, vpnSourceSvc, inboundChargeSvc, tierSvc, userTierSvc := serviceInitializer.GetServices(&cfg)
